...
latex_documents = [
    (master_doc, 'pyPPG.tex', 'pyPPG Documentation',
     'Author', 'manual'),
]
...
man_pages = [
    (master_doc, 'pyPPG', 'pyPPG Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pyPPG', 'pyPPG Documentation',
     author, 'pyPPG', 'One line description of project.',
     'Miscellaneous'),
]
...
html_theme_googleanal = 'analytics'
html_theme_path_googleanal = ['_includes']
